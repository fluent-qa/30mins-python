...
from spells.Logo import Logo
from spells.iceshell.tools.Phraser import alias
from spells.logs.Info import ProgramInfo
from spells.logs.color import Colors
from spells.logs.iprint import iPrintLog


class SelfCheck:
    def WelcomeStart(self):
